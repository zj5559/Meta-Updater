...
class RTMD_MU_ori_Tracker(object):
    ...
    def tc_init(self, model_dir):
        path = '../models/RTMDNet_MU_ori.pth.tar'
    ...
    def tracking(self, image):
        ...
        return [float(self.last_gt[1]), float(self.last_gt[0]), float(width), float(height)], top_scores, iou, ap_dis.data.cpu().numpy()[0], ap_dis.data.cpu().numpy()[0]
