...
class Ocean(object):
    ...
    def update(self, net, x_crops, target_pos, target_sz, window, scale_z, p):
        ...
        return target_pos, target_sz, cls_score[r_max, c_max],cls_score,pscore
    def updateTemplate(self,state,im):
        if self.i>500:
            self.i=0
    ...
    def track(self, state, im, online_score=None, gt=None):
        ...
        target_pos, target_sz, max_score,score,pscore = self.update(net, x_crop.cuda(), target_pos, target_sz*scale_z, window, scale_z, p)
