...
class VOT(SeqDataset):
    ...
    """
    __valid_versions = [2013, 2014, 2015, 2016, 2017, 2018, '2018LT',
                        2019, '2019LT', 'RGBD2019', 'RGBT2019']
    ...
    def __init__(self, root_dir=None, version=2019, anno_type='rect',
        ...
        if root_dir is None:
            root_dir = osp.expanduser('/media/zj/4T/Dataset/VOT/VOT{}'.format(version))
