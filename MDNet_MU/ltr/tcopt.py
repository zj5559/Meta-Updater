...
# lstm
tcopts['lstm_train_dir'] = '/media/zj/4T-1/model/ltmu_new2/mdnet_mu'
tcopts['train_data_dir'] = '/home/zj/tracking/LTMU_Expansion/LTMU-master/MDNet_MU/results_old/MDNet/lasot/train_data'
tcopts['pos_thr'] = 0.5
tcopts['lstm_initial_lr'] = 1e-3
tcopts['lstm_decay_steps'] = 20#50000
tcopts['lstm_input'] = [0, 1, 2, 3, 6, 7, 8, 9, 10, 11,12]
