...
def _compute_iou(boxA, boxB):
    ...
    return iou
class MDNet_MU_ori_Tracker(object):
    ...
    def tracking(self, image):
        ...
        # Save result
        region = bbreg_bbox
        self.dis_record.append(target_dist[0])
        self.lof_dis_record.append(lof_dis[0])
        ...
        if len(self.state_record) >= self.p.start_frame:
            ...
            logits,_ = self.tc_model.net(tc_input)
            success = logits[0][0] < logits[0][1]
