...
# lstm
tcopts['lstm_train_dir'] = '/media/zj/4T-1/model/ltmu_new2/Dimp_MU'
tcopts['train_data_dir'] = '/home/zj/tracking/LTMU_Expansion/MetaUpdater/code_official/DiMP_MU/results/Dimp/lasot/train_data'
tcopts['pos_thr'] = 0.5
tcopts['neg_thr'] = 0.0
...
tcopts['map_units'] = 4
tcopts['training_data']=['lasot']
tcopts['val_data']=['lasot']
