...
from local_path import otb_dir
...
class OTB(SeqDataset):
    ...
    __tb50_seqs = ['Basketball', 'Biker', 'Bird1', 'BlurBody', 'BlurCar2',
                   ...
                   'Shaking', 'Singer2', 'Skating1', 'Skating2','Skating2_2', 'Skiing',
    ...
    __tb100_seqs = ['Bird2', 'BlurCar1', 'BlurCar3', 'BlurCar4', 'Board',
                    ...
                    'Jogging','Jogging2', 'KiteSurf', 'Lemming', 'Man', 'Mhyang',
    ...
    def __init__(self, root_dir=None, version=2015, download=False):
        assert version in self.__version_dict
        if root_dir is None:
            root_dir = osp.expanduser(otb_dir)
    ...
    def _construct_seq_dict(self, root_dir, version):
        ...
        anno_files = sorted(list(chain.from_iterable(glob.glob(
            osp.join(root_dir, s, 'groundtruth_rect.txt')) for s in valid_seqs)))
